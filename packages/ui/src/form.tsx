...
// Cung cấp FormField, FormItem, FormLabel, FormControl, FormDescription, FormMessage
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <p
      ref={ref}
      id={formMessageId}
      className={cn('text-xs font-medium text-red-400 animate-in fade-in', className)}
      {...props}
    >
      {body}
    </p>
