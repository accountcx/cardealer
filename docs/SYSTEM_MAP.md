...
| **Storefront Experience** | `apps/web/app/`, `packages/ui` | 4.1 Shell & Widgets (✅ 100%), 4.2 Trang chủ 6 phân khu (✅ 100%), 4.3 Catalog /xe (🔄 Đang Triển Khai), 4.4 /xe/[slug] | 🔄 **Phase 4.3** |
